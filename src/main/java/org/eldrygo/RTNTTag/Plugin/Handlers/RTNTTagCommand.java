...
public class RTNTTagCommand implements CommandExecutor {
    ...
    public RTNTTagCommand(ChatUtils chatUtils, ConfigManager configManager, GameManager gameManager, LoadUtils loadUtils, BombManager bombManager) {
    ...
    public boolean onCommand(CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        if (!sender.hasPermission("rtnttag.admin") && !sender.isOp()) {
